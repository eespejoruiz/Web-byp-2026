...
export const productsData = [
  ...
  // ni deducido. Los ocho modelos llevan control MFTouch.
  {
    id: "mondialforni-mondial",
    brand: "mondialforni",
    name: "Horno Mondial",
    category: "Horno de pisos de tubos de vapor",
    description:
      "Horno de pisos de tubos de vapor para panaderías y pastelerías artesanales o semiindustriales que producen piezas de gran formato. Recupera el principio de cocción de los hornos de vapor tradicionales con un sistema anular de tubos y doble barra de horneo de 27 mm.",
    specs: {
      "Pisos": "3 o 4 según modelo, con 2 a 4 puertas por piso",
      "Superficie de horneo": "5,1 a 26,8 m² según modelo",
      "Altura entre pisos": "19 a 25 cm",
      "Combustible": "Gas natural, GLP, diésel o leña",
      "Potencia térmica": "58 a 227 kW",
      "Altura total": "230 cm",
      "Control": "MFTouch, pantalla táctil a color",
    },
    industries: ["panaderia", "cocinas-industriales", "hoteles-catering"],
    source: "https://www.mondialforni.com/en/commercial-steam-oven-mondial.htm",
    featured: true,
  },
  {
    id: "mondialforni-ecomondial",
    brand: "mondialforni",
    name: "Horno Ecomondial",
    category: "Horno de pisos de tubos de vapor",
    description:
      "Horno de pisos de tubos de vapor con gestión de temperatura más flexible, para producciones que necesitan fuerte aporte de calor desde la solera y generación abundante de vapor. Descarga de vapor automatizada y encendido y apagado programables.",
    specs: {
      "Pisos": "3, 4 o 5 según modelo, con 2 o 3 puertas por piso",
      "Medida de piso": "124×165 a 186×218 cm",
      "Superficie de horneo": "6,1 a 20,3 m² según modelo",
      "Potencia térmica": "34 a 110,5 kW (29.500 a 95.000 kcal/h)",
      "Potencia eléctrica": "1,5 kW a 400 V",
      "Dimensiones": "175-237 × 289-342 × 230 cm",
      "Peso": "4.000 a 8.200 kg según configuración",
      "Control": "MFTouch, pantalla táctil a color",
    },
    industries: ["panaderia", "cocinas-industriales"],
    source: "https://www.mondialforni.com/en/commercial-steam-oven-ecomondial.htm",
    featured: false,
  },
  {
    id: "mondialforni-lem",
    ...
    category: "Horno de pisos de tubos de vapor",
    description:
      "Horno compacto de tubos de vapor con estructura de acero inoxidable, pensado para tiendas y obradores con limitación de espacio o con producciones de temporada. Es la puerta de entrada a la cocción de tubos de vapor sin necesitar una planta grande.",
    specs: {
      "Pisos": "4",
      "Superficie de horneo": "4 m² (piso de 82×125 cm) o 6 m² (piso de 82×185 cm)",
      "Alturas útiles": "19 · 19 · 19 · 24 cm",
      "Potencia térmica": "32 kW (27.500 kcal/h) o 42 kW (36.100 kcal/h)",
      "Potencia eléctrica": "1,5 kW",
      "Dimensiones": "136 × 207 × 200 cm o 136 × 268 × 200 cm",
      "Peso": "2.000 kg o 2.450 kg",
      "Control": "MFTouch, pantalla táctil a color",
    },
    industries: ["panaderia", "hoteles-catering"],
    source: "https://www.mondialforni.com/en/commercial-steam-oven-lem.htm",
    featured: false,
  },
  {
    id: "mondialforni-dekomondial",
    brand: "mondialforni",
    name: "Horno Dekomondial",
    category: "Horno eléctrico de pisos",
    description:
      "Horno eléctrico de pisos para obradores artesanales, retail y pequeña industria. Cada piso es independiente y lleva su propia sonda de temperatura, así que se puede hornear a la vez a temperaturas distintas sin esperar a que el horno se estabilice.",
    specs: {
      "Pisos": "3, 4 o 5 según modelo",
      "Profundidad de piso": "81, 124 o 186 cm",
      "Largo de piso": "165, 205 o 245 cm",
      "Alturas útiles": "20 cm (3 y 4 pisos) · 18 cm (5 pisos)",
      "Superficie de horneo": "4 a 22,8 m² según modelo",
      "Potencia (400 V)": "11,8 a 55,8 kW · 14,8 a 63,8 kW con vaporizador",
      "Peso": "1.300 a 6.600 kg según configuración",
      "Control": "MFTouch con sonda por piso, hasta 80 recetas",
    },
    industries: ["panaderia", "supermercados", "cocinas-industriales"],
    source: "https://www.mondialforni.com/en/commercial-electric-oven-dekomondial.htm",
    featured: true,
  },
  {
    id: "mondialforni-domino",
    brand: "mondialforni",
    name: "Horno Domino",
    category: "Horno eléctrico de pisos",
    description:
      "Horno eléctrico de pisos modular para pan, pastelería y pizza en bandeja. Once configuraciones que van de 2 a 8 pisos, para artesanos, retail, hoteles, restaurantes y catering que necesitan adaptar el equipo al espacio disponible.",
    specs: {
      "Configuraciones": "11 modelos, de 2 a 8 pisos",
      "Superficie de horneo": "0,5 a 2 m² según modelo",
      "Medida de piso": "62×82 a 124×162 cm",
      "Alturas útiles": "18 a 25 cm, regulables por piso",
      "Potencia eléctrica": "2,9 a 8,1 kW · 1,5 a 3 kW más con vaporizador",
      "Control": "MFTouch, hasta 80 recetas de 9 fases cada una",
    },
    industries: ["panaderia", "restaurantes", "hoteles-catering", "supermercados"],
    source: "https://www.mondialforni.com/en/commercial-electric-oven-domino.htm",
    featured: false,
  },
  {
    id: "mondialforni-techno",
    brand: "mondialforni",
    name: "Horno rotativo Techno",
    category: "Horno rotativo",
    description:
      "Horno rotativo de carro para pan y pastelería, en versión a gas o eléctrica. Incorpora el sistema de flujo de aire MondialForniBTT, doble flujo DAF y evacuación rápida de vapor Speed Dry; en las versiones de combustión, intercambiador Turbolator.",
    specs: {
      "Medidas de carro": "46×76 · 60×80 · 60×100 · 80×100 cm",
      "Capacidad": "10 a 20 bandejas según modelo y separación",
      "Calentamiento": "Gas o eléctrico",
      "Potencia térmica": "52 a 114 kW a gas (44.000 a 98.000 kcal/h)",
      "Potencia eléctrica": "33,5 a 79,8 kW a 400 V",
      "Control": "MFTouch, hasta 80 recetas de 9 fases, con acceso por contraseña",
    },
    industries: ["panaderia", "supermercados", "cocinas-industriales"],
    source: "https://www.mondialforni.com/en/commercial-electric-oven-techno.htm",
    featured: true,
  },
  {
    id: "mondialforni-basic",
    brand: "mondialforni",
    name: "Horno rotativo Basic",
    category: "Horno rotativo",
    description:
      "Horno rotativo de carro, eléctrico o de combustión, para panaderías, pastelerías y cadenas de supermercado que buscan versatilidad y consumo contenido. Admite seis medidas de bandeja y cinco separaciones entre pisos.",
    specs: {
      "Capacidad": "15 bandejas",
      "Medidas de bandeja": "40×60 · 45×75 · 46×76 · 50×70 · 60×65 · 60×80 cm",
      "Separación entre pisos": "140 · 107 · 90 · 77 · 69 mm",
      "Calentamiento": "Gas o eléctrico",
      "Potencia a gas": "32 kW (4060) · 47 kW (4575) · 53 kW (6080)",
      "Potencia eléctrica": "21,6 a 34,2 kW según modelo",
      "Dimensiones": "99×146×200 · 119×174×200 · 131×186×200 cm",
      "Control": "MFTouch, hasta 80 recetas de 9 fases",
    },
    industries: ["panaderia", "supermercados"],
    source: "https://www.mondialforni.com/en/commercial-oven-basic.htm",
    featured: false,
  },
  {
    id: "mondialforni-slim",
    brand: "mondialforni",
    name: "Horno rotativo Slim",
    category: "Horno rotativo",
    description:
      "Horno rotativo eléctrico compacto para tiendas que quieren hornear en sala sin ocupar una planta. Usa el sistema de circulación MondialForniBTT y evacuación de vapor Speed Dry, y admite base con soporte de bandejas o cámara de fermentación.",
    specs: {
      "Pisos": "3",
      "Superficie de horneo": "2,16 m²",
      "Capacidad": "8, 9 o 10 bandejas de 40×60 cm",
      "Separación entre pisos": "100 · 88 · 80 mm",
      "Calentamiento": "Eléctrico",
      "Dimensiones": "100 × 120 × 199 × 180 cm",
      "Peso": "467 a 527 kg según configuración",
      "Control": "MFTouch, pantalla táctil a color",
    },
    industries: ["panaderia", "supermercados", "bares-cafeterias"],
    source: "https://www.mondialforni.com/en/commercial-electric-oven-slim.htm",
    featured: false,
  },
  /* ---------------- RONDO ---------------- */
  {
