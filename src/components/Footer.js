            ...
            <div className="row justify-content-center">
              <div className="col-lg-3 col-md-6 col-sm-12 " >
                <div className="widget widget_about">
                  ...
                  <h5 className="m-b20">B&P TECH</h5>
                  <p>Soluciones tecnológicas para la industria alimentaria: diseño, equipamiento y soporte para operaciones de alto rendimiento.</p>
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="widget widget_categories p-l50">
                  <div className="widget-title">
                    <h5 className="title">Enlaces Rápidos</h5>
                  </div>
                  <ul>
                    <li className="cat-item"><Link to="/industria/restaurantes">Restaurantes</Link></li>
                    <li className="cat-item"><Link to="/industria/bares-cafeterias">Bares y Cafeterías</Link></li>
                    <li className="cat-item"><Link to="/industria/hoteles-catering">Hoteles y Catering</Link></li>
                    <li className="cat-item"><Link to="/industria/panaderia">Panadería y Pastelería</Link></li>
                    <li className="cat-item"><Link to="/industria/supermercados">Supermercados</Link></li>
                    <li className="cat-item"><Link to="/casos-de-exito">Casos de Éxito</Link></li>
                  </ul>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 col-sm-6" >
                <div className="widget widget_categories">
                  ...
                  <ul>
                    <li className="cat-item"><Link to={'/contacto'}>Soporte técnico</Link></li>
                    <li className="cat-item"><Link to={'/blog'}>Blog</Link></li>
                    <li className="cat-item"><Link to="/nosotros">Nosotros</Link></li>
                    <li className="cat-item"><Link to={'/'}>Inicio</Link></li>
          ...
          <div className="container">
            <div className="row align-items-center fb-inner spno">
              <div className="col-12 text-center">
                <span className="copyright-text">&copy; {new Date().getFullYear()} B&amp;P TECH. Desarrollado con amor por Selva Ecomarketing.</span>
              </div>
            </div>
          </div>
        </div>
